...
const OrderPage = () => {
  ...
  if (loading) {
    return <LoadingSpinner fullPage={true} text="Загрузка данных..." />;
  }
          ...
          <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
            ...
            {token && (
                <div className="mb-6">
                  ...
                  {addresses.length === 0 ? (
                      <div>Нет доступных адресов. Пожалуйста, добавьте его в профиле.</div>
                  ) : (
                      <>
                        <select
                        ...
                        >
                          <option value="" disabled selected={!selectedAddress}>
                            Выберите адрес
                          </option>
